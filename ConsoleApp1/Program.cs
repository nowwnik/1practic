...
namespace RefactorMe
{
    ...
    {
        public static void DrawSide1(int shirina, int visota)
        {
        ...
        public static void DrawSide2(int shirina, int visota)
        {
            var sz = Math.Min(shirina, visota);
        ...
        public static void DrawSide3(int shirina, int visota)
        {
            var sz = Math.Min(shirina, visota);
            Risovatel.makeIt(Pens.Yellow, sz * 0.375f, Math.PI);
        ...
        public static void DrawSide4(int shirina, int visota)
        {
            var sz = Math.Min(shirina, visota);
            Risovatel.makeIt(Pens.Yellow, sz * 0.375f, Math.PI / 2);
            Risovatel.makeIt(Pens.Yellow, sz * 0.04f * Math.Sqrt(2), Math.PI / 2 + Math.PI / 4);
